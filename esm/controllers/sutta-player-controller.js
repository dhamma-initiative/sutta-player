...
export class SuttaPlayerController {
    ...
    constructor(appRoot, albumStorage) {
        ...
        this.audDurWait = new DeferredPromise();
    ...
    _registerNavigationListeners() {
        ...
        let mainMenuOnChangeListener = (e) => {
            const el = e.target;
    ...
    _registerDisplayListeners() {
        ...
        this._view.revealInCatElem.onclick = async (event) => {
    ...
    async _onRevealInCatalog(srcSel) {
    ...
    async _loadShareLinkIfSpecified() {
